package com.marcosjr.osworks.api.controller;
...
import com.marcosjr.osworks.api.model.OrdemServicoInput;
import com.marcosjr.osworks.api.model.OrdemServicoRepModel;
...
import com.marcosjr.osworks.domain.service.GestaoOrdemServicoService;
...
public class OrdemServicoController {
	...
	public ResponseEntity<OrdemServicoRepModel> buscar(@PathVariable Long ordemServicoId)  {
		...
		if (ordemServico.isPresent()) {
			OrdemServicoRepModel ordemServicoModel = modelMapper.map(ordemServico.get(), OrdemServicoRepModel.class);
